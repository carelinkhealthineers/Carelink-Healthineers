...
export const VideoTheatreModal: React.FC<VideoTheatreModalProps> = ({
  ...
  return createPortal(
    <div 
      className="fixed inset-0 z-[999999] flex flex-col items-center justify-center bg-slate-950/95 backdrop-blur-xl p-2 sm:p-4 selection:bg-blue-600 selection:text-white overflow-hidden"
    ...
    >
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_30%,rgba(37,99,235,0.18),transparent_60%)] pointer-events-none" />
